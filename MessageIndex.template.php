...
function template_main()
{
	...
	<div class="pagesection">
		...
		{
			echo '
	<div id="description_board" class="alert alert-info">
		<h3 class="d-inline-block">', $context['name'], '</h3>
		<span>';
	...
	<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" class="clear" name="quickModForm" id="quickModForm">';
		...
		if (!empty($context['topics']))
		{
			...
			foreach ($context['topics_headers'] as $menu) {

				echo preg_replace('/<a /', '<a class="dropdown-item" ', $menu);
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo'
			  <div class="row no-gutters ', $topic['css_class'], '">
				 
				<div class="col-2 col-md-1 text-right">
			   ', $topic['views'], '<br><small>', $txt['views'], '</small>
				</div>
			...
			if ($topic['is_poll'])
				...
				', $topic['is_posted_in'] ? '<img class="posted" src="' . $settings['images_url'] . '/icons/profile_sm.png" alt="">' : '', '
				 <strong>', $topic['first_post']['member']['link'], ',</strong>
				 ...
				 <small><a href="', $topic['first_post']['href'],'">', $txt['dyz_view'], '  ', $topic['replies'], ' ', $txt['replies'], '</a></small>
				 <div class="first-post-time float-right">
				 <small>' . $topic['first_post']['time'] . '</small>
				 </div>
