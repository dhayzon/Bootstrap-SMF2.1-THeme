...
function template_custom_single_post($message){
	...
	// Show the message anchor and a "new" anchor if this message is new.
	echo '
				<div class="',$is_post? 'post':'comment','">
					', $message['id'] != $context['first_message'] ? '
					<a id="msg' . $message['id'] . '"></a>' . ($message['first_new'] ? '<a id="new"></a>' : '') : '', '
					<div class="post_wrapper">';
					...
					echo'
						<div class="row no-gutters">';
							...
							echo'
							<div class="',$is_post? 'col-12':'col-11','">';
												 
								// Show a link to the member's profile.
							 
								echo'								
								<div class="inner',$is_post? ' post':'','" data-msgid="', $message['id'], '" id="msg_', $message['id'], '"', $ignoring ? ' style="display:none;"' : '', '>
