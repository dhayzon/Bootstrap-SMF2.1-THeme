...
function template_generic_menu_dropdown_above()
{
	...
	// Load the menu
	// Add mobile menu as well //', $txt['mobile_user_menu'], '
	echo '
...
function template_generic_menu(&$menu_context)
{
	...
	{
		//href="', $section['url'], $menu_context['extra_parameters'], '"
		echo '
						<li class="nav-item ', !empty($section['areas']) ? 'dropdown' : '', '">

						<a class="nav-link dropdown-toggle ', !empty($section['selected']) ? 'active ' : '', '"" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">', $section['title'], !empty($section['amt']) ? ' <span class="amt">' . $section['amt'] . '</span>' : '', '</a> 
		...
		foreach ($section['areas'] as $i => $area)
		{
			...
			echo '
								<div  id="menu_',$i,'"  ', !empty($area['subsections']) ? ' ' : '', '>
									<a  class="dropdown-item" class="', $area['icon_class'], !empty($area['selected']) ? ' chosen ' : '', '" href="', (isset($area['url']) ? $area['url'] : $menu_context['base_url'] . ';area=' . $i), $menu_context['extra_parameters'], '">', $area['icon'], $area['label'], !empty($area['amt']) ? ' <span class="amt">' . $area['amt'] . '</span>' : '', '</a>';
			...
			if (!empty($area['subsections']))
			{
				...
				foreach ($area['subsections'] as $sa => $sub)
				{
					...
					echo '
										<li>
											<a  class="dropdown-item ', !empty($sub['selected']) ? 'chosen ' : '', '" href="', $url, $menu_context['extra_parameters'], '">', $sub['label'], !empty($sub['amt']) ? ' <span class="amt">' . $sub['amt'] . '</span>' : '', '</a>
										</li>';
				}
